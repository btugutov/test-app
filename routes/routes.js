...
// classes
const { debugLog, getLineNumber, log_event, log_object_parser, dbQueryMethod, logEvent, getEventLog, getEventLogByID } = require('../backend/classes.js');
// methods
...
module.exports = function (app) {
    ...
    app.post('/api/getQuizLength', (req, res) => {
        getQuizLength(req.body.quiz_id).then(quiz => {
            ...
            logEventParser("ERROR", err, "routes.js", "getQuizLength", null)
        })
    })
    ...
    */
    ...
    app.post('/api/get_availableEngagements', (req, res, next) => {
        get_available_engagements_by_profile_id(req.body.profile_id).then(response => {
            ...
            logEventParser("ERROR", err, "routes.js", "/api/get_availableEngagements: get_available_engagements_by_profile_id", req.body.profile_id);
            res.json(err);
        })
    });
